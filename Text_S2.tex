...
We also calculated the $L_1$ and $L_2$ matrix distance norms for (each pair of) the estimates of $\mathbf{Q}$ obtained from each subsample.
...
Our calculations were very similar for the two norms, hence only results from the $L_1$ norm will be presented.
