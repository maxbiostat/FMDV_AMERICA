...
1-- $\times 10^{-3}$; 2 -- $\times 10^{-2}$; 3-- Probability distribution at root node; 4-- Kullback-Liebler Divergence (see Text) }
\begin{tabular}{cccccc}
\toprule
...
1-- $\times 10^{-3}$; 2--  Probability at root node; 3-- Kullback-Liebler Divergence (see Text).}
\begin{tabular}{cccccc}
\toprule
