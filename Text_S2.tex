...
% We assessed the impact of fixed base frequencies for the locations, as follows: we allowed 
...
For this analysis, we used the Gaussian Markov Random Field (GMRF) smoothing prior on coalescent times, also known as the `skyride' model.
...
\begin{figure}[H]
\begin{center}
\subfigure[A]{\includegraphics[scale=.450]{FIGURES/cattle_trade_network.jpeg}}
\subfigure[B]{\includegraphics[scale=.450]{FIGURES/pig_trade_network.jpeg}}\\
\subfigure[C]{\includegraphics[scale=.450]{FIGURES/sheep_trade_network.jpeg}}
\end{center}
\caption{}
