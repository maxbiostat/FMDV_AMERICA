...
\subfigure[O]{\includegraphics[width=\textwidth]{FIGURES/SFig_O2000sky.jpeg}}\\
\end{center}
\caption{}
...
% TODO: Put the time series for livestock trade here
...
\textbf{Figure S~\ref{sfig:bssvsA}. Bayesian Stochastic Search Variable Selection for five downsampled subsamples of serotype A sequences} We performed the BSSVS analysis on 
\textbf{Figure S~\ref{sfig:bssvsO}.   }
\newpage
