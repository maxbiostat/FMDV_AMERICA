...
%LM: I beg to strongly differ: we have over 100 taxa trees, with many internal nodes. The way to do it I think would be to put pie charts on the internal nodes of interest. 
