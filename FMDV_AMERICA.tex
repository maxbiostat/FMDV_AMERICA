...
The 1980-2008 window is characterized by the introduction of FMDV serotype A in Peru and Paraguay and the increase of intra-country diversity (depicted by the radius of the displayed circles in Figure~\ref{fig:migration}). % TODO: LM: is the word 'introduction' correctly placed here??   
...
While serotype O presented average $Pr(root=Colombia)=0.95$, $Pr(root=Brazil)$ for serotype A was $0.83$.
% TODO: check this numbering in the end
...
% Relate sampling bias to SHARED analyses
