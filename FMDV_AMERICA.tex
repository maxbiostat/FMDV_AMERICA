...
<<<<<<< HEAD
In this paper we employ modern phylodynamic methods to merge epidemiological and genetic data to reconstruct spatiotemporal patterns and determinants of the two most prevalent FMDV serotypes A and O dispersal in South America. %GB: if these are the main serotypes, we should stress this already here; also, we'll have to list our main findings as a result of employing these phylodynamic methods; in particular, the use of the different nonparametric coalescent models and what we can learn from these, may be worth mentioning
%LM: partially addressed. Will write more in the end.
=======
...
>>>>>>> 70003a1eefa926aa60457e03dc38f71a7caa684d
}
...
<<<<<<< HEAD
%LM: I don't quite like spoon-feeding people stuff. But will consider the request.
=======
>>>>>>> 70003a1eefa926aa60457e03dc38f71a7caa684d
}
\label{fig:trees}
