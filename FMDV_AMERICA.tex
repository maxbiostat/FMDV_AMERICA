...
All (log) marginal likelihood estimations were performed using 64 power posteriors, which were each run for 2 million iterations, taking up to 4 weeks of computation for each model under evaluation. % LM : overall, computations took more than 4 weeks, i think we should increase this... XDD
For more details on the model selection procedures please see Text S2.
