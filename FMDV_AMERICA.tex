...
Using path sampling we obtained marginal likelihoods of $-21478$ and $-21482$ for the shared and separate models respectively.
...
For serotype A, distance and uniform outperform all the predictors tested, meaning that in itself, those predictors are not very 'predictive'.
For serotype O, the cattle predictor is the only one to outperform the distance and uniform cases and can hence be considered a valuable predictor.
