...
%NRF perhaps you can drop here some references about serotype distribution in America
...
PHEFA was elaborated and signed by South American countries as a continent-wide programme to strengthen national infra-structures, control animal trade and improve diagnostic and epidemiological investigation capabilities \cite{review_eradication}.
...
We then draw five subsamples for each serotype in which over-represented were down-sampled and performed BSSVS for each subsample.
...
\begin{itemize}
 ...
 \item ii. Parameter estimation with over-represented locations down-sampled to the number of sequences of the second most represented location (Venezuela and Colombia, for serotypes A and O, respectively). For each serotype, we obtained five random subsamples using this approach;
