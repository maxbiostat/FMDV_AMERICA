...
For example, Nelson et al. ~\cite{Nelson2011} coupled pig trade data and genetic data to show swine movements in the United States drove the spread of a novel influenza virus of the H1 subtype.
...
%GB: should we indicate this on the figure? 
%LM: really dunno. should we ask Philippe/Andrew/Nuno? 
...
%LM: again, should we indicate this? I think Nuno is the guy here [he also made the plots].
...
%GB: should we ditch the equal-rates prior? It seems out of place here. Why does the legend say we shouldn't compare the equal-rates prior to the other ones? Then we should definitely ditch it.
