...
To further study this, we also computed the $L1$ and $L2$ matrix distance norms across the estimated rate matrices for each subsample, and no aberrant samples were detected (see Text S2 for detailed results).
