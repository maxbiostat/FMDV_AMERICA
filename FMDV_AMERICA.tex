...
We show that both serotypes evolve measurably in South America and identify times to most comment recent ancestors of $\approx 70$ and $\approx 20$ years for serotypes A and O, respectively. 
...
Serotype O has historically been the most prevalent serotype on the continent and, recently, it has been limited to the  some areas in the Andean region~\cite{andean}.
...
As an overall result, our datasets presented high degree of spatial signal, what justifies more complex phylogeographic analyses to study the transmission network of FMDV on the continent.
...
These results indicated further investigation was important to assess the robustness of our phylogeographic inference to sampling. % TODO: LM: did they?
