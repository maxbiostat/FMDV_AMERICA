...
% Regarding spatial signal extraction, as measured by the Kullback-Liebler (KL) divergence (relative  to a uniform prior) at the root~\citep{Lemey2009} (see also Text S2) for each predictor, we find KL divergences ranging from $3.86$ to $5.91$, showing highly concentrated distributions at the root. 
...
% We use the Kullback-Liebler divergence of the posterior distribution at root to a uniform distribution as a measure of spatial signal extraction~\citep{Lemey2009}.
