...
%LM: TODO:  Andres thinks this is not results. Although I strongly agree, one has to keep in mind the methods section is just in the end, so MAYBE this sentence would fit in here afterall.
...
To assess the spatial pattersn of FMDV spread within South America, we performed Bayesian phylogeographic analysis, also using the models available in BEAST~\cite{roots}.
