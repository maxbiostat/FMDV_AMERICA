...
When we analyzed support for various epidemiological links, %PL: i don't really understand what is meant here or how this differs from the A and O results reported?
...
An attempt at resolving these discrepancies is to compare the spatial signal extraction, as measured by the KL divergence at the root~\cite{roots} (see also Text S2) for each predictor.
In general, KL divergences for these analyses ranged from $3.86$ to $5.91$, showing highly concentrated distributions at the root. 
