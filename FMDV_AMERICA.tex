...
We used data on trade of live cattle, pigs and sheep.
...
For serotype A we found moderate statistical support for geographic distances as predictors of viral spread (BF$=4$).
...
% differet predictors = different roots 
