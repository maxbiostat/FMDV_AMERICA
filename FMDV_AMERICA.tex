...
Moreover, the analyses with fixed frequencies yielded lower marginal likelhihoods for the predictors (data not shown).
...
We then used path sampling and stepping stone sampling to calculate marginal likelhihoods for these predictors, obtaining significantly lower marginal (log) likelihoods (-12556 and -8290, for serotypes A and O respectively).
...
To further study this, we also computed the $L1$ and $L2$ matrix distance norms for across the estimated rate matrices for each subsample, and no aberrant samples were detected (see Text S2 for detailed results).
...
% Also, when we fixed country frequencies at their observed values for each data set we noticed a substantial drop in marginal likelhihoods for all predictors.
...
\section*{Tables}
\begin{table}[!ht]
\caption{{\bf Comparison of combined and separate models for CTMC rate matrix}. Using data from both serotypes jointly, we estimated marginal likelihoods for a model in which a single rate matrix was estimated (``Shared'') and one in which two separate matrices were estimated (``Separate''). We used path sampling (PS) and stepping-stone sampling (SS) to estimate (log) marginal likelihoods for each of these two models using 64 path steps and 2 million iterations per path step.}
 \begin{center}
 \begin{tabular}{ccccccc}
 \toprule
 &\multicolumn{2}{c}{Shared}& \multicolumn{2}{c}{Separate} & \multicolumn{2}{c}{(log) Bayes Factors}\\
 \midrule
Chain length&PS&SS&PS&SS&BF -- PS&BF -- SS\\
250k&-21420&-21437&-21436&-21454&16&17\\
500k&-21442&-21456&-21450&-21467&8&11\\
1M&-21462&-21470&-21471&-21483&9&13\\
2M&-21478&-21488&-21482&-21492&4&10\\
...
%\hline
Cattle&-12588.76&-12591.26&-27.70&-8308.94&-8311.21&13.49\\
Distance&-12557.69&-12559.73&3.83&-8313.89&-8315.37&9.33\\
