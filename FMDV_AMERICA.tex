...
The  `temporal signal' test~\cite{Faria2012} (see Methods) indicated significant temporal signal for both serotypes (A: BF=$310$; O: BF=$348$), showing that both FMDV data sets analyzed here evolve measurably, a result also found for FMDV SAT 1 in East Africa~\cite{sangula}.
