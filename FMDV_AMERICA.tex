...
The rate of evolution for serotype A  was significantly higher compared to serotype O.
...
For serotype O, we observer similar results, with $16$ ($13$--$20$) and $1$ ($0$--$3$) location-transitions being observed for border (B) and non-bordering (NB) countries, respectively.
...
For serotype A, the figures have to be adjusted because we have samples from $8$ countries, resulting in $\text{B} = 26$ and $\text{NB} = 30$.
