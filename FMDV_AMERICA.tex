...
Particularly, the exponential relaxed molecular clock provided a better fit for serotype O data (BF=$21$) while the log-normal relaxed molecular clock model provided a better fit to serotype A (BF=$11$) (see Table S1 for details).
...
The results of these later experiments are presented in Text S2, Figure S1. % TODO: check this numbering in the end
...
To further study this, we also computed the $L_1$ and $L_2$ matrix distance norms across the estimated rate matrices for each subsample, and no aberrant samples were detected (see Text S2 for detailed results).
...
Tables S3 and S4 show that for all subsamples in both serotypes there was lower information extraction, with moderately concentrated posterior distributions at root.% TODO: check this numbering in the end
...
See Figure S2 for kernel density smoothing of these prior distributions.
% TODO: check this numbering in the end
%GB: you could automate this, right?
...
Pig&-12589.33&-12590.94&-27.38&-8325.39&-8326.63&-1.93\\
