...
In Figure~\ref{sfig:tradenets} we present the spatial networks of livestock trade, where we can see that the cattle trade network is substantially more connected than the pig and sheep trade networks.   
