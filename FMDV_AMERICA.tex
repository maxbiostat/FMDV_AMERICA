...
In order to achieve complete erradication however, we need accurately characterize the strains involved in epidemics, specially those in previously free areas.
...
In this context, Bayesian phylodynamics offers an attractive statistical framework to combine multiple sources of information in order to understand the spatio-temporal dynamics of FMDV and perform evolutionary hypothesis testing.
