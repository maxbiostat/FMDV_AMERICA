...
In this paper we employ modern phylodynamic methods to merge epidemiological and genetic data to reconstruct spatiotemporal patterns and determinants of FMDV serotypes A and O dispersal in South America.
}
...
\begin{figure}[H]
\begin{center}
\subfigure[A]{\includegraphics[scale=.30]{FIGURES/PLOTS/tree_A.pdf}}\\
\subfigure[O]{\includegraphics[scale=.30]{FIGURES/PLOTS/tree_O.pdf}}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=.70]{FIGURES/PLOTS/MJandBFs.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\subfigure[][]{\includegraphics[scale=.30]{FIGURES/PLOTS/Origins_A_Argentina_early_2001.pdf}}
\subfigure[][]{\includegraphics[scale=.30]{FIGURES/PLOTS/Origins_A_Ecuador_2002.pdf}}\\
\subfigure[][]{\includegraphics[scale=.30]{FIGURES/PLOTS/Origins_O_Ecuador_2002.pdf}}
\subfigure[][]{\includegraphics[scale=.30]{FIGURES/PLOTS/Origins_O_Paraguay_2011.pdf}}
\end{center}
...
\begin{figure}[H]
\begin{center}
\subfigure[][Serotype A]{\includegraphics[scale=.40]{FIGURES/PLOTS/glm_A.pdf}}
\subfigure[][Serotype O]{\includegraphics[scale=.40]{FIGURES/PLOTS/glm_O.pdf}}
\end{center}
