...
#
write.dna(bank_A[ql1, ], "../../DATA/A_subsample_1.fasta", format = "fasta")
write.dna(bank_A[ql2, ], "../../DATA/A_subsample_2.fasta", format = "fasta")
write.dna(bank_A[ql3, ], "../../DATA/A_subsample_3.fasta", format = "fasta")
write.dna(bank_A[ql4, ], "../../DATA/A_subsample_4.fasta", format = "fasta")
write.dna(bank_A[ql5, ], "../../DATA/A_subsample_5.fasta", format = "fasta")
...
#
write.dna(bank_O[ql1, ], "../../DATA/O_subsample_1.fasta", format = "fasta")
write.dna(bank_O[ql2, ], "../../DATA/O_subsample_2.fasta", format = "fasta")
write.dna(bank_O[ql3, ], "../../DATA/O_subsample_3.fasta", format = "fasta")
write.dna(bank_O[ql4, ], "../../DATA/O_subsample_4.fasta", format = "fasta")
write.dna(bank_O[ql5, ], "../../DATA/O_subsample_5.fasta", format = "fasta")
